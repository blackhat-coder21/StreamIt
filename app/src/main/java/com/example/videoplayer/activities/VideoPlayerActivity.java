                                ...
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                                    ...
                                    if (value) {
                                        if (left) {
                                            ...
                                            int new_brightness = (int) (brightness - (diffY * Speed));
                                            ...
                                            double cal = (double) diffY * ((double) maxVol / ((double) (device_height * 2) - Speed));
        ...
        playbackIconsAdapter.setOnItemClickListener(new PlaybackIconsAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                if (position == 8) {
                    ...
                    String[] items = {"0.5x", "1x ", "1.25x", "1.5x", "2x"};
                    int checkedItem = -1;
                                ...
                                alertDialogDelete.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (delete) {
                                            ...
                                            Toast.makeText(VideoPlayerActivity.this, "Can't Delete", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
