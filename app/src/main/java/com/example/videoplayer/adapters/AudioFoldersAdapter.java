...
import com.example.videoplayer.activities.AudioFilesActivity;
...
public class AudioFoldersAdapter extends RecyclerView.Adapter<AudioFoldersAdapter.ViewHolder> {
    ...
    public AudioFoldersAdapter(ArrayList<MediaFiles> mediaFiles, ArrayList<String> folderPath, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.audio_folder_item,parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull AudioFoldersAdapter.ViewHolder holder, int position) {
        ...
        holder.noOfFiles.setText(noOfFiles(folderPath.get(position))+" Audios");
